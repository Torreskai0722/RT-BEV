...
model = dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='/media/hydrapc/hdd-drive3/UniAD-data/others/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
...
data_root = "/media/hydrapc/hdd-drive3/UniAD-data/nuscenes/"
# info_root = "data/infos/"
info_root = "/media/hydrapc/hdd-drive3/UniAD-data/infos/"
