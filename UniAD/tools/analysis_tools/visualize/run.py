import cv2
# import sys
# sys.path.append('/home/hydrapc/projects/UniAD')
import torch
import argparse
import os
import glob
...
def main(args):
    ...
    viser = Visualizer(version='v1.0-trainval', predroot=args.predroot, dataroot='/media/hydrapc/hdd-drive3/UniAD-data/nuscenes', **render_cfg)
